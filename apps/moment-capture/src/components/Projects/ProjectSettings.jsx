...
const ProjectSettings = ({ isOpen, project, onClose }) => {
  ...
  useEffect(() => {
    if (project) {
      ...
      setVideoDuration(project.videoDuration || 2);
    }
  }, [project]);
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <span className="ml-2 font-semibold text-gray-900">{project.videoCount || 0}</span>
                </div>
                <div>
                  <span className="text-gray-600">Kept Videos:</span>
                  <span className="ml-2 font-semibold text-green-700">{project.keptCount || 0}</span>
                </div>
              </div>
            </div>
