...
// exactly one initialized app and one auth instance — two `initializeApp`
// calls with the same config would still be one app thanks to the getApps()
// guard, but two copies of this file is one copy too many.
//
...
// same way it does in apps/recipebox. The env overrides exist so the app can
